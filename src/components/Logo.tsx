  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      >
        ...
        <div className="h-10 w-10 bg-gradient-to-br from-gray-900 to-black border border-[#00F0FF]/30 rounded-xl flex items-center justify-center shadow-[0_0_15px_rgba(0,240,255,0.1)] relative z-10 transition-all duration-300 group-hover:border-[#00F0FF]">
